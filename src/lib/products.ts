...
const products: Product[] = [
  {
    ...
    description:
      "A timeless classic white t-shirt made from premium cotton. Versatile and comfortable for everyday wear.",
    price: 24.99,
    image: "/t-shirt.jpg?height=400&width=400",
    category: "Clothing",
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    price: 59.99,
    image: "/download 2.jpg?height=400&width=400",
    category: "Clothing",
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    price: 89.99,
    image: "/bag.jpg?height=400&width=400",
  ...
  },
  {
    ...
    price: 69.99,
    image: "/jacket.jpg?height=400&width=400",
    category: "Clothing",
    featured: false,
    inStock: true,
