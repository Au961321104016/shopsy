    ...
    <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm">
      <div className="fixed inset-y-0 right-0 w-full sm:w-[400px] bg-background shadow-lg flex flex-col">
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-5 font-semibold">Your Cart</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {cartItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h3 className="text-5 font-medium mb-2">Your cart is empty</h3>
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div className="flex items-center border rounded-md">
                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0" onClick={() => updateQuantity(item.product.id, item.quantity - 1)}> - </Button>
        ...
        {cartItems.length > 0 && (
          <div className="border-t p-4 space-y-4">
            ...
            <Button className="w-full" onClick={() => { clearCart(); onClose(); }}>Checkout</Button>
